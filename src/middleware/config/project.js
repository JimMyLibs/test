...
export const fetchType = 'football';// 决定请求地址类型分类
...
export const serverOriginUrl = `http://169.254.222.170:8803/config/GetPara_ashx.xml`;// 获取API地址前缀

export const serverPathUrl = `http://169.254.222.170:8803/config/GetPara_ashx.xml`;// 获取API地址后缀
